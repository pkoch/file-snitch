...
'
  ...
  queue_fake_macos_ui_decisions "$fake_osascript_queue_file" allow
  start_macos_ui_prompt_run
...
verify_deny_write() {
  ...
  trap cleanup_run_fixture EXIT
  queue_fake_macos_ui_decisions "$fake_osascript_queue_file" deny
  start_macos_ui_prompt_run
  platform_prime_guarded_path "$home_dir/.kube/config"
...
verify_timeout_write() {
  ...
  trap cleanup_run_fixture EXIT
  queue_fake_macos_ui_decisions "$fake_osascript_queue_file" timeout
  start_macos_ui_prompt_run
  platform_prime_guarded_path "$home_dir/.kube/config"
