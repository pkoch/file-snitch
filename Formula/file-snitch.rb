class FileSnitch < Formula
  ...
  url "https://github.com/pkoch/file-snitch/releases/download/v0.1.3/file-snitch-0.1.3-source.tar.gz"
  sha256 "84360acda687b1f70eca1550a6545456f3ac88a5fab8aace13a6b714d5ab28fe"
  version "0.1.3"
  # stable-release-end
